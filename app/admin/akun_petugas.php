...
{   
    ...
    header("location: akun_petugas.php");
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title> Ubah Akun Project PMT </title>
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <a href="akun.php"><b> Project PMT </b></a>
        </div>
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <form name="formLogin" action="akun_proses.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">Daftar sebagai petugas</button>
                    </div>
            ...
            <div class="social-auth-links text-center">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a class="btn btn-block btn-warning btn-flat" href="akun.php?id=<?php echo $r['UserID']; ?>"><i class="fa fa-user-plus"></i> Daftar sebagai admin</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
