                ...
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            include '../koneksi.php';
                            $i = 1;
                            $query = mysqli_query($connection, "SELECT * FROM peminjaman LEFT JOIN user ON peminjaman.UserID = user.UserID LEFT JOIN buku ON peminjaman.BukuID = buku.BukuID WHERE peminjaman.UserID");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                <?php
                                if($data['StatusPeminjaman'] == 'Disetujui'){?>
                                <a class="btn btn-success" href="pengembalian.php?id=<?php echo $data['PeminjamanID']; ?>">Kembalikan</a>
                                <?php
                                }elseif($data['StatusPeminjaman'] == 'Diproses'){
                                    echo "Buku sedang diproses";
                                ?>
                                <?php 
                                }elseif($data['StatusPeminjaman'] == 'Dikembalikan'){
                                    echo "Buku sudah dikembalikan";
                                ?>
                                <?php 
                                }elseif($data['StatusPeminjaman'] == 'Ditolak'){
