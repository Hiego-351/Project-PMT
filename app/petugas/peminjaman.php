            ...
            <div id="layoutSidenav_content">
                <main role="main">
                    <div class="container-fluid px-4">
                        <h1 class="fas fa-history"></h1>
                        <b align="center" class="mt-4"> Riwayat Peminjaman </b>
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                <?php 
                                if($StatusPeminjaman == 'Diproses') {
                                ?>
                                <td><a class="btn btn-success" href="peminjaman_proses.php?id=<?php echo $data['PeminjamanID']; ?>&action=setuju">Setujui</a></td>
                                <td><a class="btn btn-danger" href="peminjaman_proses.php?id=<?php echo $data['PeminjamanID']; ?>&action=tolak">Tolak</a></td>
                            </tr>
                            <?php 
