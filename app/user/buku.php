                ...
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            include '../koneksi.php';
                            $i = 1;
                            $query = mysqli_query($connection, "SELECT * FROM buku LEFT JOIN kategoribuku ON buku.KategoriID = kategoribuku.KategoriID ORDER BY kategoribuku.NamaKategori ASC, buku.Judul ASC");
