...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="petugas.php">Project PMT</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main role="main">
                    <div class="container-fluid px-4">
                        ...
                        <b>Daftar Buku</b>
                        <h2><a class="btn btn-info mt-2" href="tambah_buku.php">+Tambah Buku</a></h2>
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" cellspacing="0">
                            <tr>
                                <th>No </th>
                                <th>Cover </th>
                                <th>Kategori </th>
                            ...
                            include '../koneksi.php';
                            $i = 1;
                            $query = mysqli_query($connection, "SELECT * FROM buku LEFT JOIN kategoribuku ON buku.KategoriID = kategoribuku.KategoriID ORDER BY kategoribuku.NamaKategori, buku.Judul");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="ubah_buku.php?id=<?php echo $data['BukuID']; ?>" class="btn btn-info">Ubah</a>
                                </td>
                                <td align="center">
                                    <a href="lihat.php?id=<?php echo $data['KategoriID']; ?>" class="btn btn-primary">Lihat</a>
                                </td>
                                <td align="center">
