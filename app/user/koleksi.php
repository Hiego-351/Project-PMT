                ...
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            $query = mysqli_query($connection, "SELECT * FROM koleksipribadi LEFT JOIN buku ON koleksipribadi.BukuID = buku.BukuID LEFT JOIN user ON koleksipribadi.UserID = user.UserID WHERE koleksipribadi.UserID = '$UserID' ORDER BY buku.Judul");
