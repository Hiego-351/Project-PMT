            ...
            <div id="layoutSidenav_content">
                <main role="main">
                    <div class="container-fluid px-4">
                        ...
                        <b>Kategori</b>
                        <h2><a class="btn btn-info mt-2" href="tambah_kategori.php">+Tambah Kategori</a></h2>
                <div class="row">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            include '../koneksi.php';
                            $i = 1;
                            $query = mysqli_query($connection, "SELECT * FROM kategoribuku");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="ubah_kategori.php?id=<?php echo $data['KategoriID']; ?>" class="btn btn-info">Ubah</a>
                                    <a href="lihat.php?id=<?php echo $data['KategoriID']; ?>" class="btn btn-primary">Lihat</a>
                                    <a href="hapus_kategori.php?id=<?php echo $data['KategoriID']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php 
                            } 
