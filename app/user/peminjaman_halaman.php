		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Halaman Peminjaman</h2>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					...
					<form action="peminjaman_proses.php" method="post" class="signin-form">
					...
					<div class="form-group mb-3">
		              ...
		              <input type="number" class="form-control" name="Stok" value="<?php echo $Result['Stok'] ?>" max="<?php echo $Result['Stok'] ?>" min="0">
		            </div>
					...
					<div class="form-group mb-3">
            		  <label for="text">Tanggal Peminjaman</label>
            		 	<input type="date" class="form-control" name="TanggalPeminjaman" value="<?php echo date('Y-m-d'); ?>" readonly/>
            		  	...
            		  	<input type="hidden" value="Diproses" name="StatusPeminjaman" readonly/>
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn btn-primary submit px-3" value="Pinjam">Pinjam</button>
		            </div>
